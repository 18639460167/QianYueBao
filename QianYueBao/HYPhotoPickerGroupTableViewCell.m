//
//  HYPhotoPickerGroupTableViewCell.m
//  自定义tabbar
//
...
@interface HYPhotoPickerGroupTableViewCell()
...
@end
@implementation HYPhotoPickerGroupTableViewCell
...
- (void)setGroup:(HYPhotoPcikerGroup *)group
{
    _group = group;
